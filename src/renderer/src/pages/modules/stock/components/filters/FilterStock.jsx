            ...
            <div className="flex flex-col md:flex-row gap-4 items-center">
                <div className="relative flex-1 w-full">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 w-64 border border-gray-200 rounded-full"
                        value={searchTerm}
                ...
                <div className="w-full md:w-auto">
                    <div className="relative">
                        <select
                            className="appearance-none bg-white border border-gray-300 rounded-full pl-4 pr-10 py-2 w-full"
                            value={filterType}
